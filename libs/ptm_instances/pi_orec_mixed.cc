...
/// - Redo log with orec granularity, deferred clwbs, and coarse logging
/// - No Quiescence
...
typedef P_OrecMixed<
    OrecTable<NUM_STRIPES, 32>, P_CoarseRedoLog<32, false, false>,
...
typename P_OrecMixed<O, R, E, C, S, A>::Globals
    P_OrecMixed<O, R, E, C, S, A>::globals;
