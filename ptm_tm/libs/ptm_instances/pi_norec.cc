...
/// - Redo log with 32-byte granularity, deferred clwb, and coarse logging
/// - No Quiescence
...
template <class R, class E, class C, class S, class A, class P>
typename P_NOrec<R, E, C, S, A, P>::Globals P_NOrec<R, E, C, S, A, P>::globals;
