...
/// - Store fence pipelining
/// - ADR persistence domain
///
/// This is the "general persistent" implementation: The optimizations are
/// captured memory and store pipelining.
///
...
typedef P_TLRWEager<
    BytelockTable<NUM_STRIPES, 5, BYTELOCK_MAX_THREADS>, P_UndoLog<ADR>,
    BasicEpochManager<MAX_THREADS>,
    HourglassBackoffCM<ABORTS_THRESHOLD, BACKOFF_MIN, BACKOFF_MAX>,
    OptimizedStackFrameManager, EnhancedPersistentAllocationManager<ADR>,
