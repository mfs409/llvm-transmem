...
///
/// This is the "general persistent" implementation: The only optimization is
/// captured memory.
...
typedef P_OrecEager<
    OrecTable<NUM_STRIPES, 5, CounterTimesource>, P_UndoLog<ADR>, QuiesceEpochManager<MAX_THREADS>,
