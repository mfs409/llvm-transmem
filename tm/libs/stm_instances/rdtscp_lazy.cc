/// Instantiate the RdtscpLazy algorithm with the following configuration:
...
typedef OrecLazy<
    OrecTable<NUM_STRIPES, OREC_COVERAGE, RdtscpTimesource>, RedoLog_Atomic<2 << OREC_COVERAGE>,
