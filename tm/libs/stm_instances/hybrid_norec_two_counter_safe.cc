...
#include "../common/redolog_atomic.h"
#include "../common/stackframe.h"
#include "../common/valuelog_atomic.h"
...
typedef HybridNOrecTwoCounter<
    NUM_HTM_RETRIES, RedoLog_Atomic<32>, ValueLog_Atomic,
    IrrevocQuiesceEpochManager<MAX_THREADS>, NoopCM, OptimizedStackFrameManager,
...
template <int RT, class R, class V, class E, class C, class S, class A>
typename HybridNOrecTwoCounter<RT, R, V, E, C, S, A>::Globals
    HybridNOrecTwoCounter<RT, R, V, E, C, S, A>::globals;
