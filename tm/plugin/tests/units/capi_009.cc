...
//
// Here we ensure that using an annotated function as the root of a
// transaction leads to serializing if the annotated function is defined in
// another TU and it isn't annotated in that TU
...
int main() {
  report<int>(
      "capi_009",
      "Start from incorrectly-unmarked C function in other TU serializes",
