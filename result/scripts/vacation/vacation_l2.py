...
gptm = np.genfromtxt('result/data/vacationl_f2.txt', delimiter=',', usecols=np.arange(0,7))
gcgl = np.genfromtxt('result/data/vacationl_f2.txt', delimiter=',', usecols=7)
iptm = np.genfromtxt('result/data/vacationl_f2.txt', delimiter=',', usecols=np.arange(8,15))
icgl = np.genfromtxt('result/data/vacationl_f2.txt', delimiter=',', usecols=15)
...
plt.savefig('result/plots/fig3/vacationlow_fig3.png')
