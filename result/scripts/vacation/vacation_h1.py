...
stm = np.genfromtxt('result/data/vacationh_f1.txt', delimiter=',', usecols=np.arange(0,7))
nptm = np.genfromtxt('result/data/vacationh_f1.txt', delimiter=',', usecols=np.arange(7,14))
cgl = np.genfromtxt('result/data/vacationh_f1.txt', delimiter=',', usecols=14)
...
plt.savefig('result/plots/fig2/vacation_high_fig2.png')
